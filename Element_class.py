...
#                p = Property(None)
    ...
    def serialize(self, outfile):
        ...
        for line in self:
            ...
            elif(self.getCategory() == 'Junction' and line.getName() == 'Downstream' and line.getAsString() == 'None'):
                pass
            elif(self.getCategory() == 'Subbasin' and line.getName() == 'Area'):
                outfile.write('     ' + line.getName() + ': ' + line.getAsString() + '\n')
                outfile.write('     Downstream: ' + self.downstream.getAsString() + '\n')

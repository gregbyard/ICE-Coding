...
class HecConfig:
    ...
    def __init__(self):
        ...
        self.hmsProjectPath = self.modelVersion + "HEC-HMS/PC_TribA/"
        #self.osHmsProjectPath = self.osHmsVersion + "HMS/"
        #self.rasProjectPath = self.modelVersion + "RAS/PCEB/"
        self.hmsProjectName = "PC_TribA"
        self.parent_hecConfig = "parent_hecConfig_Poplar"
        self.basinin = self.hmsProjectPath + "/PC_TribA_Exist.basin.backup"
        self.basinout = self.hmsProjectPath + "/PC_TribA_Exist.basin"

...
def setme1(self):
    ...
    self.hmsDir="HEC-HMS"
    self.modelPath = "G:/PROJECTS_non-FEMA/MWRD_ReleaseRate_PhaseII/H&H/CalSag_models/"
    #self.modelPath = "C:/Users/nschiff2/Documents/MWRD/CalSag_models/"
    self.modelVersion = self.modelPath + "v007/"
    ...
    self.osModelVersion = self.modelPath + "v007_SOcurves/" #self.modelPath + "USC_V11.0optim"
...
def setme2hms(self):
    ...
    self.scenario = "HuffQII_100yr12Hr"
    self.hmsRunName = self.scenario #"HuffQII_100yr12hrISWS" #"HuffQIII_100yr24hrISWS"
    self.hmsMetFile = self.hmsProjectPath + "/" + self.scenario #"/HuffQII_100yr12hrISWS" #"/HuffQIII_100yr24hrISWS"
    self.hmsGageName = self.scenario #"HuffQII_100yr12hrISWS" #"HuffQIII_100yr24hrISWS"
...
def setme2ras(self):
    ...
    self.rasPlanName = "100YR12hrHuffQII"

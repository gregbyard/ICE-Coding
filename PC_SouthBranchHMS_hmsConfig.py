...
class HecConfig:
    ...
    def __init__(self):
        ...
        self.hmsProjectPath = self.modelVersion + "HEC-HMS/PC_SouthBranchHMS/"
        #self.osHmsProjectPath = self.osHmsVersion + "HMS/"
        #self.rasProjectPath = self.modelVersion + "RAS/PCEB/"
        self.hmsProjectName = "SouthBranch_Poplar"
        self.parent_hecConfig = "parent_hecConfig_Poplar"
        self.basinin = self.hmsProjectPath + "/PoplarCreek_SouthBra.basin.backup"
        self.basinout = self.hmsProjectPath + "/PoplarCreek_SouthBra.basin"

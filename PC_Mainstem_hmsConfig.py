...
class HecConfig:
    ...
    def __init__(self):
        ...
        self.hmsProjectPath = self.modelVersion + "HEC-HMS/PC_Mainstem/"
        #self.osHmsProjectPath = self.osHmsVersion + "HMS/"
        #self.rasProjectPath = self.modelVersion + "RAS/PCEB/"
        self.hmsProjectName = "Poplar_Creek_Main"
        self.parent_hecConfig = "parent_hecConfig_Poplar"
        self.basinin = self.hmsProjectPath + "/PoplarCreekMain.basin.backup"
        self.basinout = self.hmsProjectPath + "/PoplarCreekMain.basin"
